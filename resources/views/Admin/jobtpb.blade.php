...
@section('title','JOB PROGRRES DIVISION TPB')
@section("css")
...
@section('content')
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/add-jobtpb" method="POST" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="modal-body">

                    <div class="form-group">
                        <label>User</label>
                        <input type="text" name="User_Tpb" class="form-control" required readonly>
                        <input type="hidden" name="id" >
                    </div>

                    <div class="form-group">
                        <label>To Do</label>
                        <input type="text" name="To_Do_Tpb" class="form-control" required readonly>
                        <input type="hidden" name="id" >
                    </div>

                    <div class="form-group">
                        <label>Progress</label>
                        <input type="text" name="Progress_Tpb" class="form-control" required readonly>
                        <input type="hidden" name="id" >
                    </div>

                    <div class="form-group">
                        <label>Done</label>
                        <input type="text" name="Done_Tpb" class="form-control" required readonly>
                        <input type="hidden" name="id" >
                    </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/update-jobtpb" method="POST" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="modal-body">
                    <div class="form-group">
                        <label>User</label>
                        <input type="text" name="User_Tpb" value="{{ $Tpb ->User_Tpb }}" class="form-control" readonly>
                        <input type="hidden" name="id" value="{{ $Tpb ->id }}">
                    </div>

                    <div class="form-group">
                        <label>To Do</label>
                        <input type="text" name="To_Do_Tpb" value="{{ $Tpb ->To_Do_Tpb }}" class="form-control" readonly>
                        <input type="hidden" name="id" value="{{ $Tpb ->id }}">
                    </div>

                    <div class="form-group">
                        <label>Progress</label>
                        <input type="text" name="Progress_Tpb" value="{{ $Tpb ->Progress_Tpb }}" class="form-control" readonly>
                        <input type="hidden" name="id" value="{{ $Tpb ->id }}">
                    </div>

                    <div class="form-group">
                        <label>Done</label>
                        <input type="text" name="Done_Tpb" value="{{ $Tpb ->Done_Tpb }}" class="form-control" readonly>
                        <input type="hidden" name="id" value="{{ $Tpb ->id }}">
                    </div>

                    <div class="form-group">
                        <label>Komentar Manager</label>
                        <input type="text" name="KomentarManager_Tpb" value="{{ $Tpb ->KomentarManager_Tpb }}" class="form-control" required>
                        <input type="hidden" name="id" value="{{ $Tpb ->id }}">
                    </div>

                    <div class="form-group">
                        <label>Komentar Asisten Manajer</label>
                        <input type="text" name="KomentarAsistenManajer_Tpb" value="{{ $Tpb ->KomentarAsistenManajer_Tpb }}" class="form-control" required>
                        <input type="hidden" name="id" value="{{ $Tpb ->id }}">
                    </div>
                </div>
        </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <a href="/delete-jobtpb/{{$Tpb->id}}" class="btn btn-danger">Delete</a>
        </form>
    </div>
    </div>
    </div>
