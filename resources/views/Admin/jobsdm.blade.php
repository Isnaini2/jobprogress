...
@section('title','JOB PROGRRES DIVISION SDM')
@section("css")
...
<section id="faq" class="faq">
    <div class="container">
        <div class="row text-center">
            <h1 class="display-3 fw-bold text-uppercase">JOB PROGRESS DIVISI SDM</h1>
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="/add-jobsdm" method="POST" enctype="multipart/form-data">
            {{ csrf_field()}}
            <div class="modal-body">

                <div class="form-group">
                    <label>User</label>
                    <input type="text" name="User_sdm" class="form-control" readonly>
                    <input type="hidden" name="id" >
                </div>

                <div class="form-group">
                    <label>To Do</label>
                    <input type="text" name="To_Do_sdm" class="form-control" readonly>
                    <input type="hidden" name="id" >
                </div>

                <div class="form-group">
                    <label>Progress</label>
                    <input type="text" name="Progress_sdm" class="form-control" readonly>
                    <input type="hidden" name="id" >
                </div>

                <div class="form-group">
                    <label>Done</label>
                    <input type="text" name="Done_sdm" class="form-control" readonly>
                    <input type="hidden" name="id" >
                </div>
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="/update-jobsdm" method="POST" enctype="multipart/form-data">
            {{ csrf_field()}}
            <div class="modal-body">
                <div class="form-group">
                    <label>User</label>
                    <input type="text" name="User_sdm" value="{{ $js ->User_sdm }}" class="form-control" readonly>
                    <input type="hidden" name="id" value="{{ $js ->id }}">
                </div>

                <div class="form-group">
                    <label>To Do</label>
                    <input type="text" name="To_Do_sdm" value="{{ $js ->To_Do_sdm }}" class="form-control" readonly>
                    <input type="hidden" name="id" value="{{ $js ->id }}">
                </div>

                <div class="form-group">
                    <label>Progress</label>
                    <input type="text" name="Progress_sdm" value="{{ $js ->Progress_sdm }}" class="form-control" readonly>
                    <input type="hidden" name="id" value="{{ $js ->id }}">
                </div>

                <div class="form-group">
                    <label>Done</label>
                    <input type="text" name="Done_sdm" value="{{ $js ->Done_sdm }}" class="form-control" readonly>
                    <input type="hidden" name="id" value="{{ $js ->id }}">
                </div>

                <div class="form-group">
                    <label>Komentar Manager</label>
                    <input type="text" name="KomentarManager_sdm" value="{{ $js ->KomentarManager_sdm }}" class="form-control" required>
                    <input type="hidden" name="id" value="{{ $js ->id }}">
                </div>

                <div class="form-group">
                    <label>Komentar Asisten Manajer</label>
                    <input type="text" name="KomentarAsistenManajer_sdm" value="{{ $js ->KomentarAsistenManajer_sdm }}" class="form-control" required>
                    <input type="hidden" name="id" value="{{ $js ->id }}">
                </div>
            </div>
    </div>
...
<div class="modal-content">
    ...
    <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    <a href="/delete-jobsdm/{{$js->id}}" class="btn btn-danger">Delete</a>
    </form>
</div>
</div>
</div>
