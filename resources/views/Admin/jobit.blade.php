...
@section('title','JOB PROGRRES DIVISION IT')
@section("css")
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/add-jobit" method="POST" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="modal-body">

                    <div class="form-group">
                        <label>User</label>
                        <input type="text" name="User_IT" class="form-control" readonly>
                        <input type="hidden" name="id" >
                    </div>

                    <div class="form-group">
                        <label>To Do</label>
                        <input type="text" name="To_Do_IT" class="form-control" readonly>
                        <input type="hidden" name="id" >
                    </div>

                    <div class="form-group">
                        <label>Progress</label>
                        <input type="text" name="Progress_IT" class="form-control" readonly>
                        <input type="hidden" name="id" >
                    </div>

                    <div class="form-group">
                        <label>Done</label>
                        <input type="text" name="Done_IT" class="form-control" readonly>
                        <input type="hidden" name="id" >
                    </div>
...
<div class="modal fade" id="updateModal-{{$it->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/update-jobit" method="POST" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="modal-body">
                    <div class="form-group">
                        <label>User</label>
                    ...
                    <div class="form-group">
                        <label>Komentar Manager</label>
                        <input type="text" name="KomentarManager_IT" value="{{ $it ->KomentarManager_IT }}" class="form-control" required>
                        <input type="hidden" name="id" value="{{ $it ->id }}">
                    </div>

                    <div class="form-group">
                        <label>Komentar Asisten Manajer</label>
                        <input type="text" name="KomentarAsistenManajer_IT" value="{{ $it ->KomentarAsistenManajer_IT }}" class="form-control" required>
                        <input type="hidden" name="id" value="{{ $it ->id }}">
                    </div>
                    </div>
        </div>
...
<div class="modal fade" id="deleteModal-{{$it->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <a href="/delete-jobit/{{$it->id}}" class="btn btn-danger">Delete</a>
        </form>
    </div>
    </div>
    </div>
...
<script>
    function exportData() {
      ...
      link.setAttribute("download", "Job IT.csv");
